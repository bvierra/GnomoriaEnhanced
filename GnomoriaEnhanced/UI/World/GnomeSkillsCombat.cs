...
{
    public partial class GnomesSkillsCombat : Form
    {
        #region Variables
        ...
        #region Form
        public GnomesSkillsCombat(GnomoriaEnhanced.UI.WorldForm parent)
        {
            ...
            _professionSkillList = SkillDef.AllCombatSkills();
